...
namespace App2.Views.MixedDataPages
{
    ...
    public partial class FileInfoPage : ContentPage
    {
        ...
        Button btnPlayVideo;
        ToolbarItem TlbShare = new ToolbarItem { Text = "Share" };

        public FileInfoPage(AEF file)
        {
            TlbShare.Clicked += ShareFile;
            ToolbarItems.Add(TlbShare);
        ...
        private async void ShareFile(object sender, EventArgs e)
        {
            ...
            {
                Title = Title,
                File = new ShareFile(file.OutputName)
            });
        }
        ...
        async void HandleCache()
        {
            ...
            if (AEF.CacheUsageAtTheMoment > App.session.MaxCacheUsage)
            {
